...
// transfinite arcs 
Transfinite Line {1, 2, 3, 4, 5, 6, 7, 8, 33, 34, 35, 36, 9, 10, 11, 12, 13, 14, 15, 16, 41, 42, 43, 44, 90, 100, 110, 120, 130, 140, 150, 160, 410, 420, 430, 440} = 11;
//n_se

// transfinite radial lines 
// in orifice
Transfinite Line {17, 18, 19, 20, 21, 22, 23, 24, 421, 422, 423, 424} = 5;
//n_r1

// outside orifice
Transfinite Line {37, 38, 39, 40, 49, 50, 51, 52, 490, 500, 510, 520} = 41 Using Progression 1.0;
//

// transfinite axial lines
// section 1
Transfinite Line {25, 26, 27, 28, 29, 30, 31, 32, 45, 46, 47, 48} = 161;
//n_ax1

// section 2
Transfinite Line {525, 526, 527, 528, 529, 530, 531, 532, 450, 460, 470, 480} = 367  Using Progression 1.0035;
// n_ax2
